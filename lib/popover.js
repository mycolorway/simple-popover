(function() {
  ...
  Popover = (function(_super) {
    ...
    Popover.prototype.refresh = function() {
      var arrowHeight, arrowOffset, arrowWidth, bottomNotEnough, delta, direction, directions, left, leftEnough, pointToHeight, pointToHeightOffset, pointToOffset, pointToWidth, popoverHeight, popoverWidth, rightNotEnough, scrollLeft, scrollTop, top, topEnough, winHeight, winWidth;
      ...
      if (this.opts.position) {
        ...
        bottomNotEnough = winHeight + scrollTop - pointToOffset.top - pointToHeightOffset < popoverHeight + arrowOffset;
        rightNotEnough = winWidth + scrollLeft - pointToOffset.left - pointToWidth < popoverWidth + arrowOffset;
        ...
        if (rightNotEnough && leftEnough) {
          direction[0] = "left";
        }
        if (bottomNotEnough && topEnough) {
          direction[1] = "top";
        }
